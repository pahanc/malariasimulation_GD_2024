...
create_adult_mosquito_model <- function(growth_model, mu, tau, supp_tseries, emerge_tseries, susceptible, foim) {
    .Call(`_malariasimulation_create_adult_mosquito_model`, growth_model, mu, tau, supp_tseries, emerge_tseries, susceptible, foim)
}
