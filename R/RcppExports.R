...
create_adult_mosquito_model <- function(growth_model, mu, tau, mosq_suppression, mosq_seasonality, susceptible, foim) {
    .Call(`_malariasimulation_create_adult_mosquito_model`, growth_model, mu, tau, mosq_suppression, mosq_seasonality, susceptible, foim)
}

adult_mosquito_model_update <- function(model, mu, foim, mosq_suppression, mosq_seasonality, susceptible, f) {
    invisible(.Call(`_malariasimulation_adult_mosquito_model_update`, model, mu, foim, mosq_suppression, mosq_seasonality, susceptible, f))
}
