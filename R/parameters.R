...
get_parameters <- function(overrides = list(),square_number=square_number, supp_gam=supp_gam, supp_arab=supp_arab, supp_fun=supp_fun,
  ...
  supp_filename_gamb<-paste("W:\\Seas and supp species specific/With funestus suppression/Houet suppression files Feb25/Fitness 0.65 strat/1km/1100/",supp_gam_filename,sep="")
  ...
  #An. gambiae/coluzzii
  seas_filename_gamb<-paste("W:\\Seas and supp species specific/With funestus suppression/Houet emergence files/",emerge_gam_filename,sep = "")
