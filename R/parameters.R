...
get_parameters <- function(overrides = list(),square_number=square_number, supp_gam=supp_gam, supp_arab=supp_arab, supp_fun=supp_fun,
  ...
  supp_filename_gamb<-paste("Q:\\for_hpc\\Seas and supp species specific/With funestus suppression/May 24 Sourou Suppress multi/",supp_gam_filename,sep="")
  ...
  #An. arabiensis
  supp_filename_arab<-paste("Q:\\for_hpc\\Seas and supp species specific/With funestus suppression/May 24 Sourou Suppress multi/",supp_arab_filename,sep="")
  ...
  #An. funestus
  #supp_filename_fun<-paste("Q:\\for_hpc\\Seas and supp species specific/With funestus suppression/Mar 24 Sourou/Mar 24 Sourou Suppress/",supp_fun_file,sep="")
  ...
  #An. gambiae/coluzzii
  seas_filename_gamb<-paste("Q:\\for_hpc\\Seas and supp species specific/With funestus suppression/May 24 Sourou Emerge multi/",emerge_gam_filename,sep = "")
  ...
  #An. arabiensis
  seas_filename_arab<-paste("Q:\\for_hpc\\Seas and supp species specific/With funestus suppression/May 24 Sourou Emerge multi/",emerge_arab_filename,sep = "")
  ...
  #An. funestus
  #seas_filename_fun<-paste("Q:\\for_hpc\\Seas and supp species specific/With funestus suppression/May 23 Emerge/",emerge_fun_filename,sep = "")
  ...
  #Non-target vector species
  seas_filename_new<-paste("Q:\\for_hpc\\Seas and supp species specific/With funestus suppression/May 24 Sourou Emerge multi/",emerge_arab_filename,sep = "")
