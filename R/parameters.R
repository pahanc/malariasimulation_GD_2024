...
get_parameters <- function(overrides = list(),square_number=square_number, supp_gam=supp_gam, supp_arab=supp_arab, supp_fun=supp_fun,
  ...
  #An. gambiae/coluzzii
  seas_filename_gamb<-paste("Q:\\for_hpc\\Seas and supp species specific/With funestus suppression/Mar 24 Sourou/Mar 24 Sourou Emerge/",emerge_gam_filename,sep = "")
  ...
  #Non-target vector species
  seas_filename_new<-paste("Q:\\for_hpc\\Seas and supp species specific/With funestus suppression/Mar 24 Sourou/Mar 24 Sourou Emerge/",emerge_arab_filename,sep = "")
