...
get_parameters <- function(overrides = list(),square_number=square_number, supp_gam=supp_gam, supp_arab=supp_arab, supp_fun=supp_fun,
  ...
  supp_filename_gamb<-paste("W:\\for_hpc/Seas and supp species specific/With funestus suppression/Houet suppression files Feb26/Strat/1km/",supp_gam_filename,sep="")
