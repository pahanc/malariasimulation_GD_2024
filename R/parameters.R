...
get_parameters <- function(overrides = list(),square_number=square_number, supp_gam=supp_gam, supp_arab=supp_arab, supp_fun=supp_fun,
  ...
  supp_filename_gamb<-paste("Q:\\for_hpc\\Seas and supp species specific/With funestus suppression/May 24 Sourou Suppress/",supp_gam_filename,sep="")
  ...
  #An. arabiensis
  supp_filename_arab<-paste("Q:\\for_hpc\\Seas and supp species specific/With funestus suppression/May 24 Sourou Suppress/",supp_arab_filename,sep="")
  ...
  #An. gambiae/coluzzii
  seas_filename_gamb<-paste("Q:\\for_hpc\\Seas and supp species specific/With funestus suppression/May 24 Sourou Emerge/",emerge_gam_filename,sep = "")
  ...
  #An. arabiensis
  seas_filename_arab<-paste("Q:\\for_hpc\\Seas and supp species specific/With funestus suppression/May 24 Sourou Emerge/",emerge_arab_filename,sep = "")
  ...
  #Non-target vector species
  seas_filename_new<-paste("Q:\\for_hpc\\Seas and supp species specific/With funestus suppression/May 24 Sourou Emerge/",emerge_arab_filename,sep = "")
